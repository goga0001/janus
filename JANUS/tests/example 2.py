...
if __name__ == '__main__':
    ...
    agent = JANUS(
        ...
        start_population = "tests/DATA/sample_start_smiles.txt",   # file with starting smiles population
        **params_dict
    )
    ...
    params_dict = utils.from_yaml(
        ...
        start_population = "tests/DATA/sample_start_smiles.txt",
        yaml_file = 'tests/default_params.yml',       # default yaml file with parameters
